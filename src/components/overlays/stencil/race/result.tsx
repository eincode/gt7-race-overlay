...
export default function RaceStandingsOverlay() {
  ...
  const kicker = session
    ? `RACE RESULT · ${session.status.toUpperCase()}`
    : "RACE RESULT";
    ...
    <div style={S.stage}>
      ...
      <header style={S.header}>
        ...
        >
          ...
          <h1 style={S.title}>RACE RESULTS</h1>
        </div>
