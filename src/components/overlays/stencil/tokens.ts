...
export const clip = {
  ...
  slashBoth:  'polygon(18px 0, calc(100% - 18px) 0, 100% 18px, 100% calc(100% - 18px), calc(100% - 18px) 100%, 18px 100%, 0 calc(100% - 18px), 0 18px)',
...
export function sectorColor(status: string): string {
  switch (status) {
    case 'purple': return ST.fastest;
    case 'green':  return ST.gain;
    case 'red':    return ST.loss;
