...
// Raw CSV — ID,Name,MakerID (no commas inside names)
const RAW = `24,180SX Type X '96,28
31,Camaro Z28 '69,7
...
967,efini RX-7 Type R (FD) '91,21
...
3440,911 Turbo S Leichtbau (964) '93,136
...
3601,Captur S Edition TCe 140 '21,34
3602,U9 '24,165
3603,Twingo '93,34`;
...
export const CAR_LIST: Car[] = RAW.trim()
  ...
  .map((line) => {
    ...
    return {
      ...
      makerId: parseInt(line.slice(lastComma + 1), 10),
    };
  })
